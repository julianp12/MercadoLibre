...
from mcp_server_papers.domain.model.paper.gateway.resource_repository import ResourceRepository
...
@pytest.mark.asyncio
@patch("mcp_server_papers.domain.model.paper.gateway.resource_repository.ResourceRepository.__abstractmethods__", set())
