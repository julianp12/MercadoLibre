...
from mcp_server_papers.domain.model.paper.gateway.paper_repository import PaperRepository
...
@pytest.mark.asyncio
@patch("mcp_server_papers.domain.model.paper.gateway.paper_repository.PaperRepository.__abstractmethods__", set())
