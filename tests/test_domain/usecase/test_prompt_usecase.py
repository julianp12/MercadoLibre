...
from mcp_server_papers.domain.model.paper.gateway.prompt_repository import PromptRepository
...
@pytest.mark.asyncio
@patch("mcp_server_papers.domain.model.paper.gateway.prompt_repository.PromptRepository.__abstractmethods__", set())
